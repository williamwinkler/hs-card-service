...
// NewGetV1CardsParams creates a new GetV1CardsParams object
// with the default values initialized.
func NewGetV1CardsParams() GetV1CardsParams {
...
// GetV1CardsParams contains all the bound params for the get v1 cards operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Cards
type GetV1CardsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV1CardsParams() beforehand.
func (o *GetV1CardsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV1CardsParams) bindAttack(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetV1CardsParams) validateAttack(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindClass(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validateClass(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindHealth(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validateHealth(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindKeywords(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetV1CardsParams()
		return nil
	}
...
func (o *GetV1CardsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindManaCost(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validateManaCost(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validateName(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validatePage(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindRarity(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) validateRarity(formats strfmt.Registry) error {
...
func (o *GetV1CardsParams) bindSet(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1CardsParams) bindType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}

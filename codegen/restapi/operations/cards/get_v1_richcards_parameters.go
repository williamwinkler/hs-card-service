...
// NewGetV1RichcardsParams creates a new GetV1RichcardsParams object
// with the default values initialized.
func NewGetV1RichcardsParams() GetV1RichcardsParams {
...
// GetV1RichcardsParams contains all the bound params for the get v1 richcards operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetV1Richcards
type GetV1RichcardsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewGetV1RichcardsParams() beforehand.
func (o *GetV1RichcardsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetV1RichcardsParams) bindAttack(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetV1RichcardsParams) validateAttack(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindClass(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validateClass(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindHealth(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validateHealth(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindKeywords(rawData []string, hasKey bool, formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetV1RichcardsParams()
		return nil
	}
...
func (o *GetV1RichcardsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindManaCost(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validateManaCost(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validateName(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindPage(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validatePage(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindRarity(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) validateRarity(formats strfmt.Registry) error {
...
func (o *GetV1RichcardsParams) bindSet(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetV1RichcardsParams) bindType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
